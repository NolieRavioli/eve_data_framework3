...
Entry point::
    ...
    from workers.publicData.MarketStation import fetch_all_market_data
    enqueue("Market Station Orders", fetch_all_market_data, owner_id=0, queue="public")
"""
...
def fetch_all_market_data() -> None:
    ...
    for region_id in region_ids:
        logger.info("[MarketStation] Fetching region %s", region_id)
        try:
            ...
            for page in range(2, total_pages + 1):
                ...
                if total_pages < 50 or page % 7 == 0:
                    logger.info("[MarketStation] Region %s: %.2f%% complete", region_id, 100 * page / total_pages)
