"""
esi/public_api/insurance.py
AUTO-GENERATED — do not edit by hand.
Source: ESI 2025-12-16  |  Tag: Insurance  |  Scope: public_api
...
def get_insurance_prices() -> dict | None:
    """List insurance levels.
    Cache: 3600s.
    """
    result = execute_operation('GetInsurancePrices', path_params=None, token=None)
