...
from core.tasks.task_manager.queue import _registry, _registry_lock, get_all_tasks
...
try:
    from core.esi.request import set_post_request_hook as _set_esi_hook
...
try:
    from core.esi.request import set_post_request_detail_hook as _set_esi_detail_hook
...
def rate_stream():
    ...
    """
    from core.esi.request import get_esi_rate_limiter
