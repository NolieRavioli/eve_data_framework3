...
Writes three always-regenerated packages:
    ...
    collectors/personal_generatedESI/    — character-scoped routes

    collectors/corp_generatedESI/        — corporation-scoped routes

    collectors/public_generatedESI/      — unauthenticated public routes
...
def _render_file(tag: str, ops: list[tuple[str, dict]], date: str, scope: str) -> str:
    ...
    lines.append("from core.esi.generated.client import execute_operation, fetch_all_pages")
...
def generate_collectors(
    ...
    Read OPERATIONS / OPERATIONS_BY_TAG from core.esi.generated.manifest and write
    ...
    compatibility_date:
        ...
        ``core.esi.generated.manifest.COMPATIBILITY_DATE``.
    ...
    from core.esi.generated.manifest import OPERATIONS, OPERATIONS_BY_TAG, COMPATIBILITY_DATE as _MANIFEST_DATE
